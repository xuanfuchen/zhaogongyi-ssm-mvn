...
<tr>
	<td>
		姓　名<s:textfield name="cond.fullName" />&nbsp;
		个人介绍<s:textfield name="cond.introduce" />&nbsp;
		简历ID<s:textfield name="cond.resumeId" cssStyle="width:60px;"/>&nbsp;
		城市
...
<script type="text/javascript">
	...
	var OPER_TYPE_RESUME = "<%=com.zhaogongyi.util.Constants.OPER_TYPE_RESUME%>";
	function del() {
		if (!hasCheck('cbGroup')) {
			return;
		}
	...
	function submitForm() {
		...
		var reqStr = _contextPath + "/admin/myAdminResumeList.do?pager.thisPage=1";
		document.frm.action = reqStr;
		document.frm.submit();
	}
