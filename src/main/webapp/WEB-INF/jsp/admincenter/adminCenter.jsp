										...
										<table width='100%' cellpadding='0' cellspacing='0' class="subitem-1">
						    				<tr>
												<td align='left' height='24px'>
													<a onclick="changeStyle(this,'itementry')" name="itementry" href="<%=path %>/my/toChgPwd.do" target="userFrame">修改密码2</a>
												</td>
											</tr>
											<tr>
												<td align='left' height='24px'>
													<a onclick="changeStyle(this,'itementry')" name="itementry" href="<%=path %>/my/toChgEmail.do" target="userFrame">修改邮箱</a>
												</td>
											</tr>
										</table>
									</td>
								...
								<tr id="tr2">
									<td style="padding: 0px 0px 0px 20px;">
										<table width='100%' cellpadding='0' cellspacing='0' class="subitem-1">
						    				<tr>
												<td align='left' height='24px'>
													<a onclick="changeStyle(this,'itementry')" name="itementry" href="<%=path %>/admin/myAdminResumeList.do?pager.thisPage=1" target="userFrame">管理简历</a>
												</td>
											</tr>
										</table>
									</td>
								...
								<tr id="tr3">
									<td style="padding: 0px 0px 0px 20px;">
										<table width='100%' cellpadding='0' cellspacing='0' class="subitem-1">
											<tr>
												<td align='left' height='24px'>
													<a onclick="changeStyle(this,'itementry')" name="itementry" href="<%=path %>/admin/myAdminJobList.do?pager.thisPage=1" target="userFrame">管理招聘</a>
												</td>
											</tr>
											
											<tr>
												<td align='left' height='24px'>
													<a onclick="changeStyle(this,'itementry')" name="itementry" href="<%=path %>/admin/myAdminCompanyList.do?pager.thisPage=1" target="userFrame">管理公司</a>
												</td>
											</tr>
...
<td><%-- 右边的iframe --%>
	<iframe id="userFrame" name="userFrame" src="<%=path %>/admincenter/adminFrame" width="100%" height="900" frameborder="0" scrolling="auto"></iframe>
</td>
</tr>
</table>
</td>
