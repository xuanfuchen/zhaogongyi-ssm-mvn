...
<script type="text/javascript">
	function submitForm() {
		...
		if (!confirm("确定填写无误并保存公司资料？")) {
			return;
		}
		document.frm.action = _contextPath + '/my/newCompanyInfo.do';
		document.frm.submit();
	}
</script>
</head>
...
<tr>
	...
	<td>
		<s:textarea name="company.remark" id="company.remark" cssStyle="width:400px; height:150px;" 
...
<tr>
	<td>&nbsp;</td>
	<td><input type="button" id="fabu" class="confirm-verify" onclick="submitForm()" value="确定保存"/></td>
</tr>
</table>
</s:form>
</body>
