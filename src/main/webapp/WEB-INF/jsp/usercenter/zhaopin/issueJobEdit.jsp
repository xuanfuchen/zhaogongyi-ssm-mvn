...
<script type="text/javascript">
	function submitForm(wid) {
		...
		if (!confirm("是否修改招工信息？")) {
	   	...
	   	document.frm.action = _contextPath + "/my/editJob.do?wid=" + wid;
	   	document.frm.submit();
 	}
...
<tr>
	...
	<td style="border-right-width: 0" colspan="1">
		<jsp:include page="/commons/jsp/include/placeSelect.jsp">
			<jsp:param name="curPlace" value="${workInfo.place.placeId }"/>
			<jsp:param name="curPlaceName" value="${workInfo.placeName }"/>
...
<tr>
	<td>&nbsp;</td>
	<td>
		<input type="button" class="confirm-verify" onclick="submitForm(${workInfo.workId })" value="修改招聘信息" />&nbsp;&nbsp;
