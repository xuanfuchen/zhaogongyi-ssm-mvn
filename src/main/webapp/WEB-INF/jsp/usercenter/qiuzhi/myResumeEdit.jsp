...
function submitForm(rid) {
	...
	document.frm.action = _contextPath + '/my/edit/' + rid;
	document.frm.submit();
}
</script>
</head>
<body>
	<form:form id="frm" name="frm" method="POST" commandName="resumeInfo" acceptCharset="UTF-8">
		<table width="100%" border="0" cellspacing="0" cellpadding="5">
			<tr class="personal-ifram-1">
				<td colspan="3" align="left"><span class="personl-ifram-char-1">修改简历信息</span></td>
			</tr>
			<tr>
						...
						<div class="jibenziliao">
							<table width="100%" border="<%=border%>" bordercolor="green" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td style="border-right-width: 0;" colspan="2">${resumeInfo.fullName }</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2" style="border-right-width: 0"><form:input path="jiguan" id="jiguan" maxlength="15"
											cssClass=".notNull newinp" onblur='chngBorderColorHideMsgDiv(this);checkId(this,"","mess4","请填写籍贯，长度为1-15位。")'
								...
								<tr>
									...
									<td style="border-right-width: 0" colspan="2">
										...
										%>
										<form:select path="education" items="${educations }"></form:select>
									</td>
								</tr>
							</table>
						</div>
						...
						<div class="zhaogongyixiang">
							<table width="100%" border="<%=border%>" bordercolor="green" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td style="border-right-width: 0" colspan="2"><form:input maxlength="20" path="email" id="email"
											cssClass=".notNull .isEmail newinp" onblur='chngBorderColorHideMsgDiv(this);checkId(this,"","mess6","填入你的常用邮箱，你也可以使用注册帐号的默认邮箱")'
								...
								<tr>
									...
									<td style="border-right-width: 0" colspan="2"><jsp:include page="/commons/jsp/include/placeSelect.jsp">
											<jsp:param name="curPlace" value="${place.placeId }" />
											<jsp:param name="curPlaceName" value="${place.placeName }" />
											<jsp:param name="selectNameValue" value="place.placeId" />
											<jsp:param name="hiddenNameValue" value="place.placeName" />
										</jsp:include></td>
								</tr>
								...
								<tr>
									...
									<td width="160" style="border-right-width: 0">
										<form:input path="workTypeName" id="workTypeName" cssClass=".notNull newinp"
											cssStyle="cursor: pointer;" readonly="readonly" onclick="showWorkType('workTypeName')"
											onkeydown="if (window.event.keyCode!=8) execCommand('undo')" onkeyup="if (window.event.keyCode!=8) execCommand('undo')" /> 
											<form:hidden path="workTypeIdFk" id="workTypeId"/>
								...
								<tr>
									...
									<td style="border-right-width: 0" colspan="2">
										...
										%>
										<form:select path="exprTime" items="${exprTimes }"></form:select>年
									</td>
								</tr>
								...
								<tr>
									...
									<form:textarea path="introduce" cols="50" rows="8" id="introduce" cssClass=".notNull text"
											onfocus='chngBorderColorShowMsgDiv("","",this);checkId(this,"","mess8","请输入自我介绍")' onblur="chngBorderColorHideMsgDiv(this)" /><label
										id="mess8"></label></td>
								</tr>

								<tr>
									<td>&nbsp;</td>
									<td colspan="2"><input type="button" value="确定修改" onclick="submitForm(${resumeInfo.resumeId })" style="padding-top: 4px;"
										class="confirm-verify">&nbsp;&nbsp; <input type="button" value="返回" onclick="window.history.go(-1)" style="padding-top: 4px;"
										class="confirm-verify">&nbsp;&nbsp;</td>
								</tr>
							</table>
						</div>
					</div>
